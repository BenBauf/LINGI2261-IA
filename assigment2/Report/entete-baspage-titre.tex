...
\usepackage[pdftitle={IA-Assignement2},  % apparition ds les propriétés du doc
            pdfauthor={Groupe 1},
            pdfsubject={Artificial Intelligence - Second Assignement},
            pdfkeywords={ia},
	    colorlinks=false,
...
% En-tete
    \lhead{\texttt{LINGI2261} - Artificial Intelligence : Second assignement}        \chead{}        \rhead{Groupe 1}
