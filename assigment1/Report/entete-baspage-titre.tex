...
\usepackage[pdftitle={IA-Assignement1},  % apparition ds les propriétés du doc
            pdfauthor={Groupe 1},
            pdfsubject={Artificial Intelligence - First Assignement},
            pdfkeywords={ia},
	    colorlinks=false,
...
% En-tete
    \lhead{\texttt{LINGI2261} - Artificial Intelligence : First assignement}        \chead{}        \rhead{Groupe 1}
...
% Bas de page
    ...
    \lfoot{Partie \rightmark}        \cfoot{}        \rfoot{Page \thepage~sur~14}
